package com.zaze.utils.task.service;
...
import com.zaze.utils.task.NotifyMode;
    ...
    private void notifyFastTask(long currentRunTime) {
        if (currentRunTime - lastRunTimeFast > loopTimeFast) {
            ...
            while (!actionPool.isEmpty()) {
                ...
                actionSet.add(ZStringUtil.parseString(taskEntity.getTaskId()));
            }
